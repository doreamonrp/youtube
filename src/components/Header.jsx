...
const Header = () => {
    ...
    const {loading, mobileMenu, setMobileMenu} = useContext(Context); {/*Hook */}
    ...
    return (
    <div className='sticky  top-0 pt-3 pb-3 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-4 bg-white dark:bg-black'>
        {loading && <Loader/>}
        ...
        <div className='flex h-5 items-center'>
            ...
            <Link to="/" className='flex h-6 items-center mt-3 ml-2 pl-3'>
        ...
        <div className='group flex items-center'>
            ...
            <div className="flex items-center">
                <div className='hidden md:flex'>
                    ...
                    <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4 mt-1">
